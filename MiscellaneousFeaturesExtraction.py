...
dataset_file_name = 'SentimentAnalysis_Emotion_URLsCount_MentionsCount_IsRetweet_test.csv'
...
resultsFile = dataset_file_pathToFile + '/' + 'PLUS_WordsCount_' + dataset_file_name
